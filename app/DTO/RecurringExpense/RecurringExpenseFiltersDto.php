...
/**
 * Normalized filter object for recurring expense listing requests.
 */
final readonly class RecurringExpenseFiltersDto
{
    /**
     * @param  array<string>  $categories  Category enum values.
     * @param  bool|null  $isActive  Active flag filter.
     * @param  array<string>  $frequencyTypes  Frequency type enum values.
    ...
    public static function fromArray(array $filters): self
    {
        ...
        $frequencyTypes = array_values(array_filter(
            ...
            static fn (string $type): bool => FrequencyType::tryFrom($type) !== null
        ));
